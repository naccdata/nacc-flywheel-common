...
class AdminClient:
    ...
    def __get_project_admin(self) -> None:
        self.__project_admin = self.client.lookup(f"{self.__admin_group}/project-admin")
    ...
    def get_admin_file(self, filename: str):
        ...
        return [
            file for file in self.project_admin.files if file.name == filename
        ].pop()
    ...
    def upload_config_file(self, filename: str, data: Dict[str, Any]) -> None:
        ...
        file_spec = FileSpec(
            ...
            contents=yaml.safe_dump(
                data=data, allow_unicode=True, default_flow_style=False
            ),
    ...
    def run_project_management(self, study_file) -> str:
        ...
        return self.run_gear(
            ...
            inputs={"project_file": study_file},
        )
    ...
    def run_center_management(self, center_file) -> str:
        ...
        return self.run_gear(
            ...
            inputs={"center_file": center_file},
        )
    ...
    def run_file_curator(self, curator_file, input_form, destination) -> str:
        return self.run_gear(
            ...
            config={"debug": True},
            inputs={"curator": curator_file, "file-input": input_form},
    ...
    def push_templates(self) -> List[str]:
        """Executes the push-template gear for all of the instance
        templates."""
        job_ids = []
    ...
    def run_gear(
        ...
        *,
        ...
        return gear.run(config=config, inputs=inputs, destination=destination)
